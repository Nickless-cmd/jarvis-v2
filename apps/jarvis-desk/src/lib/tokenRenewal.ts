/**
 * Fornyelse af bearer-tokenet — så appen ikke låses ude af tiden alene.
 *
 * Tvilling til `apps/mobile/src/lib/tokenRenewal.ts`. De to apps deler ikke
 * kode (samme mønster som blockHelpers m.fl.), så rettelser skal gøres begge
 * steder — testene i begge apps holder på den samme kontrakt.
 *
 ...
 *
 * Egen base64url-afkoder frem for `atob`. Electron HAR `atob`, men koden er
 * holdt identisk med mobilens tvilling, så en rettelse ét sted kan kopieres
 * uden at skulle læses om først. Kravene er ren ASCII.
 *
