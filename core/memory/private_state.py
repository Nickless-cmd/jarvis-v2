...
def build_private_state_payload(
    *,
    ...
    return {
        ...
        "frustration": _frustration(private_growth_note, private_self_model),
        ...
        "curiosity": _curiosity(private_inner_note, private_growth_note),
...
def _curiosity(
    private_inner_note: dict[str, str], private_growth_note: dict[str, str]
) -> str:
