...
def _safe_guided_learning() -> dict[str, object] | None:
    try:
        from core.services.guided_learning_runtime import build_guided_learning_runtime_surface
...
def _safe_adaptive_planner() -> dict[str, object] | None:
    try:
        from core.services.adaptive_planner_runtime import build_adaptive_planner_runtime_surface
...
def _safe_adaptive_reasoning() -> dict[str, object] | None:
    try:
        from core.services.adaptive_reasoning_runtime import build_adaptive_reasoning_runtime_surface
...
def _safe_prompt_evolution() -> dict[str, object] | None:
    try:
        from core.services.prompt_evolution_runtime import build_prompt_evolution_runtime_surface
