...
def build_agentic_tool_cache_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "agentic-tool-cache",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_agentic_tool_cache_event(kind: str, payload: dict[str, object] | None = None) -> None:
    """Emit a agentic_tool_cache-scoped event. Defensive — never blocks caller.
