...
def build_anthropic_translator_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "anthropic-translator",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_anthropic_translator_event(kind: str, payload: dict[str, object] | None = None) -> None:
    """Emit a anthropic_translator-scoped event. Defensive — never blocks caller.
