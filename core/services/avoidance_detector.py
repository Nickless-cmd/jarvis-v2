...
def build_avoidance_detector_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "avoidance_detector",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_avoidance_detector_event(kind: str, payload: dict[str, object] | None = None) -> None:
