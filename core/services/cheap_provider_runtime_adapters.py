...
# Kataloget er flyttet til core/services/cheap_provider_catalogue.py
# (Boy-Scout 7/9-2026, filen var 2.051 linjer og kataloget de 628).
# Re-eksporteret her — kaldere og tests importerer det fra dette modul.
from core.services.cheap_provider_catalogue import (  # noqa: E402,F401
