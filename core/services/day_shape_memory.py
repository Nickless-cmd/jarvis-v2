...
def build_day_shape_memory_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "day_shape_memory",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_day_shape_memory_event(kind: str, payload: dict[str, object] | None = None) -> None:
