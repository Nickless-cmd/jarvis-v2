...
def build_delegation_advisor_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "delegation_advisor",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_delegation_advisor_event(kind: str, payload: dict[str, object] | None = None) -> None:
