...
def build_development_sense_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "development_sense",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_development_sense_event(kind: str, payload: dict[str, object] | None = None) -> None:
