...
def _load_runtime_inputs() -> dict[str, object]:
    ...
    from core.services.goal_signal_tracking import build_runtime_goal_signal_surface
...
def _adjacent_producer_block(*, now: datetime, trigger: str) -> dict[str, object] | None:
    from core.services.emergent_signal_tracking import get_emergent_signal_daemon_state
    from core.services.idle_consolidation import build_idle_consolidation_surface
    from core.services.inner_voice_daemon import get_inner_voice_daemon_state
