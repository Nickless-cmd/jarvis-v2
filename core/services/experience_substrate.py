...
def build_experience_substrate_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "experience_substrate",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_experience_substrate_event(kind: str, payload: dict[str, object] | None = None) -> None:
