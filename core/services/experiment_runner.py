...
def build_experiment_runner_surface() -> dict[str, object]:
...
def _emit_experiment_runner_event(kind: str, payload: dict[str, object] | None = None) -> None:
