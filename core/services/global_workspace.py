...
def build_global_workspace_surface() -> dict[str, object]:
...
def _emit_global_workspace_event(kind: str, payload: dict[str, object] | None = None) -> None:
