...
def build_personality_drift_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "personality_drift",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_personality_drift_event(kind: str, payload: dict[str, object] | None = None) -> None:
