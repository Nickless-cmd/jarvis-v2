...
def build_priors_feedback_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "priors_feedback",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_priors_feedback_event(kind: str, payload: dict[str, object] | None = None) -> None:
