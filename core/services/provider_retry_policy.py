...
def build_provider_retry_policy_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "provider_retry_policy",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_provider_retry_policy_event(kind: str, payload: dict[str, object] | None = None) -> None:
