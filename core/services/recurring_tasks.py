...
def build_recurring_tasks_surface() -> dict[str, object]:
...
def _emit_recurring_tasks_event(kind: str, payload: dict[str, object] | None = None) -> None:
