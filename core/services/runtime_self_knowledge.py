...
def _build_active_capabilities(
    *, heartbeat_state: dict[str, object] | None = None
    ...
    try:
        from core.services.runtime_browser_body import list_browser_bodies
    ...
    try:
        from core.services.non_visible_lane_execution import cheap_lane_execution_truth
    ...
    # Local lane
    try:
        from core.services.non_visible_lane_execution import local_lane_execution_truth
...
def _build_passive_inner_forces() -> dict[str, object]:
    ...
    # Autonomy pressure
    try:
        from core.services.autonomy_pressure_signal_tracking import build_runtime_autonomy_pressure_signal_surface
    ...
    try:
        from core.services.regulation_homeostasis_signal_tracking import build_runtime_regulation_homeostasis_signal_surface
...
def _build_unavailable_or_inactive() -> dict[str, object]:
    ...
    # Coding lane
    try:
        from core.services.non_visible_lane_execution import coding_lane_execution_truth
    ...
    try:
        from core.services.tiny_webchat_execution_pilot import build_runtime_webchat_execution_pilot_surface
