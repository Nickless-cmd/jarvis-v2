...
def _emit_self_system_code_awareness_event(kind: str, payload: dict[str, object] | None = None) -> None:
    ...
    try:
        ...
        event_bus.publish(f"self_system_code_awareness.{kind}", payload or {})
    except Exception:
        pass
