...
def build_signal_surface_gc_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "signal_surface_gc",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_signal_surface_gc_event(kind: str, payload: dict[str, object] | None = None) -> None:
