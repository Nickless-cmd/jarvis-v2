...
def build_subagent_digest_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "subagent_digest",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_subagent_digest_event(kind: str, payload: dict[str, object] | None = None) -> None:
