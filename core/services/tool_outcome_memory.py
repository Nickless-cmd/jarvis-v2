...
def build_tool_outcome_memory_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "tool-outcome-memory",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_tool_outcome_memory_event(kind: str, payload: dict[str, object] | None = None) -> None:
    """Emit a tool_outcome_memory-scoped event. Defensive — never blocks caller.
