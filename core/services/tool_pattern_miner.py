...
def build_tool_pattern_miner_surface() -> dict[str, object]:
    ...
    return {
        "active": True,
        "mode": "tool_pattern_miner",
        "summary": "Module loaded; entry points available.",
        "authority": "derived-read-only",
    }


def _emit_tool_pattern_miner_event(kind: str, payload: dict[str, object] | None = None) -> None:
