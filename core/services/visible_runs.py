...
# Klassifikationen af et afbrudt run bor nu i visible_run_interruption
# (Boy Scout-udskillelse 19/9-2026). Re-eksporteret, så importer ikke brækker.
from core.services.visible_run_interruption import classify_visible_run_interruption as _classify_visible_run_interruption  # noqa: E402,F401
            ...
            if simple_results:
                ...
                for _agentic_round in range(_AGENTIC_MAX_ROUNDS):
                    ...
                    if _hollow_await_outcome:
                        ...
                        _hp_resolved = True   # ved vi det ikke, siger vi ingenting
                        try:
                            from core.services.hollow_promise_round import note_outcome as _hp_out
                            _hp_resolved = _hp_out(
                                run_id=run.run_id, provider=str(_active_provider or ""),
                        ...
                        # eventbussen og ikke andet: Bjørn så et løfte, skrev
                        ...
                        if not _hp_resolved and _hollow_promise_nudges >= _HOLLOW_MAX_NUDGES:
                            ...
                            try:
                                from core.services.central_core import central as _c_hp
                                _c_hp().observe({
                                    "cluster": "loop",
                                    "nerve": "hollow_promise_unresolved_after_force",
                                    "run_id": str(run.run_id or ""),
...
# core/services/grounded_capability_followup.py (Boy-Scout 2026-09-07, filen var
# 7.352 linjer). Re-eksporteret her, så eksisterende kaldere og tests der
# importerer dem fra visible_runs virker uændret.
from core.services.grounded_capability_followup import (  # noqa: E402,F401
