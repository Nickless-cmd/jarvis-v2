...
status: forældet
audited: 2026-07-08
ground_truth: "Verified via: (1) git log shows last commit 2026-04-28, over 2 months stale; (2) runtime.json shows visible_model_provider="github-copilot" model "gpt-4.1", NOT "Ollama qwen3.5:397b-cloud" as doc claims (major factual error); (3) grep of simple_tools_definitions.py: found 136 uni"
