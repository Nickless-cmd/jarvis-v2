...
status: droppet
audited: 2026-07-08
ground_truth: "Git verification: (1) `git tag -l` shows NO v1.0.0 or v2.0.0 tags; latest actual release is jarvis-desktop-v0.3.23. (2) `pyproject.toml` lists version=0.1.0, not 2.0.0. (3) CHANGELOG added 2026-04-28 via commit 99fc259f "Add complete documentation suite" but versions claimed in i"
---
# 📝 Changelog — Jarvis V2
