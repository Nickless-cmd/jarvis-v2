...
status: forældet
audited: 2026-07-08
ground_truth: "Verified: (1) Document created 2026-05-27 19:22, describes v0.1.0-poc; current production is v0.1.8-poc. (2) Successor doc exists: CLAUDE_NOTES_WINDOWS_BUILD_v2.md (2026-05-28, v0.1.5-poc). (3) Most code claims accurate (SetupScreen.tsx exists and active, OnboardingModal removed "
superseded_by: docs/CLAUDE_NOTES_WINDOWS_BUILD_v2.md
---
