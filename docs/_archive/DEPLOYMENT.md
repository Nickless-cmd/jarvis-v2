...
status: droppet
audited: 2026-07-08
ground_truth: "Verified against actual codebase: (1) Module path: doc claims apps.api.main:app (L103,191) but actual is apps.api.jarvis_api.app:app (README.md, CLAUDE.md); (2) Dependency management: doc references requirements.txt (L89,261) but project uses pyproject.toml only (checked /media/p"
superseded_by: README.md (contains actual quickstart with correct uvicorn path)
---
