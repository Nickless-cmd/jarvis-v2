...
status: forældet
audited: 2026-07-08
ground_truth: Git log shows security commits from 2026-06-14 onwards (e4f9ed71, 731f618f, ecc58cf2, 064e187a, etc.) implementing TOTP recovery, abuse monitoring, identity guard, file permission enforcement, skill scanner. Doc claims verified against .pre-commit-config.yaml, security_headers.py
superseded_by: No single replacement doc; security features now documented in superpowers/specs/2026-06-14-totp-override-security-design.md, 2026-06-21-identity-security-guard.md, and spread across various spec files from June 2026.
---
