...
status: forældet
audited: 2026-07-08
ground_truth: "Commits verified in git (a3fa5e27, 701d0268 in main); DYNAMIC_TAIL_SENTINEL at prompt_contract.py:37, _build_visible_input logic at visible_model.py:430-454, _awareness_buffer/_dyn_tail at lines 1780-2372. Document claims 8.4% cache-ratio (2026-06-13 baseline) but commit 701d0268"
superseded_by: docs/specs/2026-06-30-wire-eventbus-and-cache-to-central.md (cache telemetry wiring); git commits 701d0268 (90%+ cache achieved), 7044f2b4 (cache-boundary observer)
---
