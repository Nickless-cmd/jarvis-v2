...
status: forældet
audited: 2026-07-08
ground_truth: "Verified: heartbeat fallback fix c1a2deb1 (2026-06-09) applied visible-lane only option (a) demoting WARNINGs; option (b) later implemented 2026-06-29 commit 09c68cae surfacing reasoning when content empty (visible_model_ollama.py lines 140-151, test_visible_thinking_fallback.py "
superseded_by: commit 09c68cae + test_visible_thinking_fallback.py — the actual implementation of option (b)
---
