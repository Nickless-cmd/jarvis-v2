...
status: forældet
audited: 2026-07-08
ground_truth: "All 3 issues verified fixed: (1) team_invite notification — fixed 2026-06-21 by commit 829607f5 (push.ts buildNotification case added); (2) operator-tools in team sessions — fixed by commits 7190e899 (tool_scope ContextVar propagation) + d70c36e1 (owner-override renewal) both 202"
---
