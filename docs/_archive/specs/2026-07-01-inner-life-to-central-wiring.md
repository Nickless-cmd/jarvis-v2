...
status: forældet
audited: 2026-07-08
ground_truth: "Codebase verification (2026-07-08): (1) desperation_awareness.py:171 & reboot_awareness_daemon.py:183 both call event_bus.publish() with CORRECT signature (string kind, dict payload) — quick-win #1 bug claim is FALSE; (2) core/runtime/db.py is 1,209 lines (NOT 33k) as of HEAD, fo"
superseded_by: docs/superpowers/plans/2026-07-05-central-governed-inner-life.md (newer refinement, dated 2026-07-05)
---
