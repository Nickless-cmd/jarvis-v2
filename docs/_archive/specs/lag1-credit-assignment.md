...
status: forældet
audited: 2026-07-08
ground_truth: "Git log + code inspection: (1) Schema migration promised (ALTER TABLE kind/outcome_aggregate) CONFIRMED in core/runtime/db_credit_assignment.py lines 41-56; (2) record_choice() function promised CONFIRMED at lines 105-157; (3) _check_credit() hook promised but RENAMED to _check_o"
superseded_by: docs/lag1-credit-assignment-design.md
---
