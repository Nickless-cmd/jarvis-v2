...
Sidst kørt: 2026-04-17T14:20:55+00:00  
Total services: 235
...
| `core/services/agent_runtime.py` | 1447 | 🟢 LIVE | 0d |
| `core/services/cheap_provider_runtime.py` | 1293 | 🟢 LIVE | 6d |
| `core/services/candidate_tracking.py` | 1208 | 🟢 LIVE | 11d |
| `core/services/runtime_cognitive_conductor.py` | 1181 | 🟢 LIVE | 4d |
| `core/services/inner_voice_daemon.py` | 1163 | 🟢 LIVE | 0d |
| `core/services/prompt_evolution_runtime.py` | 1084 | 🟢 LIVE | 4d |
| `core/services/witness_signal_tracking.py` | 1007 | 🟢 LIVE | 0d |
...
| `core/services/agent_runtime.py` | 🟢 LIVE | 1447 | 0d | yes | apps.api.jarvis_api.app, apps.api.jarvis_api.routes.mission_control, core.services.autonomous_council_daemon | 3 | test_agent_runtime_phase2.py, test_agent_runtime_phase3_scheduler.py, test_convene_council_tool.py | 9 | 7 | no | no | no |
...
| `core/services/autonomy_proposal_queue.py` | 🟢 LIVE | 542 | 6d | yes | apps.api.jarvis_api.routes.mission_control, core.services.agent_runtime, core.tools.simple_tools | 0 | — | 4 | 5 | yes | no | no |
...
| `core/services/cadence_producers.py` | 🟢 LIVE | 752 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.visible_runs | 1 | test_signal_noise_cleanup.py | 4 | 16 | yes | no | no |
| `core/services/candidate_tracking.py` | 🟢 LIVE | 1208 | 11d | yes | core.services.heartbeat_runtime, core.services.visible_runs | 1 | conftest.py | 3 | 9 | yes | no | no |
| `core/services/chat_sessions.py` | 🟢 LIVE | 307 | 3d | yes | apps.api.jarvis_api.mcp_server, apps.api.jarvis_api.routes.attachments, apps.api.jarvis_api.routes.chat | 8 | test_context_compact.py, test_heartbeat_bridge_triggers.py, test_heartbeat_execute_actions.py | 32 | 1 | no | no | no |
...
| `core/services/chronicle_consolidation_proposal_tracking.py` | 🟢 LIVE | 461 | 20d | yes | apps.api.jarvis_api.routes.mission_control, core.services.candidate_tracking, core.services.visible_runs | 1 | conftest.py | 4 | 6 | yes | no | no |
...
| `core/services/development_focus_tracking.py` | 🟢 LIVE | 533 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cadence_producers, core.services.emergent_signal_tracking | 1 | test_signal_noise_cleanup.py | 8 | 4 | yes | no | no |
...
| `core/services/dream_articulation.py` | 🟢 LIVE | 557 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.adaptive_learning_runtime, core.services.affective_meta_state | 2 | conftest.py, test_initiative_feedback.py | 13 | 11 | yes | no | no |
...
| `core/services/dream_hypothesis_signal_tracking.py` | 🟢 LIVE | 445 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.services.dream_adoption_candidate_tracking, core.services.dream_influence_proposal_tracking | 1 | conftest.py | 10 | 7 | yes | no | no |
...
| `core/services/goal_signal_tracking.py` | 🟢 LIVE | 510 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.services.dream_articulation, core.services.session_distillation | 0 | — | 6 | 3 | yes | no | no |
...
| `core/services/initiative_queue.py` | 🟢 LIVE | 307 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.conflict_resolution, core.services.heartbeat_runtime | 2 | test_heartbeat_execute_actions.py, test_initiative_feedback.py | 10 | 3 | yes | no | no |
...
| `core/services/inner_voice_daemon.py` | 🟢 LIVE | 1163 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.memory.inner_llm_enrichment, core.services.affective_meta_state | 2 | test_inner_voice_approval_reaction.py, test_inner_voice_daemon.py | 13 | 13 | yes | no | no |
...
| `core/services/internal_opposition_signal_tracking.py` | 🟢 LIVE | 446 | 22d | yes | apps.api.jarvis_api.routes.mission_control, core.services.self_review_outcome_tracking, core.services.self_review_record_tracking | 1 | conftest.py | 8 | 3 | yes | no | no |
...
| `core/services/living_heartbeat_cycle.py` | 🟢 LIVE | 126 | 10d | yes | apps.api.jarvis_api.routes.mission_control, core.services.boredom_curiosity_bridge, core.services.cadence_producers | 2 | test_living_heartbeat_cycle_smoke.py, test_signal_noise_cleanup.py | 11 | 0 | no | no | no |
...
| `core/services/loyalty_gradient_signal_tracking.py` | 🟢 LIVE | 592 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.autonomy_pressure_signal_tracking, core.services.proactive_loop_lifecycle_tracking | 1 | conftest.py | 8 | 2 | yes | no | no |
...
| `core/services/memory_decay_daemon.py` | 🟢 LIVE | 148 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.daemon_manager, core.services.heartbeat_runtime | 2 | test_adaptive_decay.py, test_memory_decay_daemon.py | 6 | 2 | yes | no | no |
...
| `core/services/ollama_visible_prompt.py` | 🟢 LIVE | 94 | 8d | yes | core.services.visible_model, core.services.visible_runs | 1 | test_ollama_visible_prompt_smoke.py | 3 | 0 | no | no | no |
...
| `core/services/reflection_signal_tracking.py` | 🟢 LIVE | 439 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.services.open_loop_closure_proposal_tracking, core.services.runtime_self_model | 1 | conftest.py | 7 | 3 | yes | no | no |
...
| `core/services/remembered_fact_signal_tracking.py` | 🟢 LIVE | 465 | 11d | yes | apps.api.jarvis_api.routes.mission_control, core.services.chronicle_consolidation_brief_tracking, core.services.chronicle_consolidation_proposal_tracking | 1 | conftest.py | 10 | 3 | yes | no | no |
...
| `core/services/runtime_decision_engine.py` | 🟢 LIVE | 513 | 5d | yes | core.services.heartbeat_runtime | 1 | test_runtime_executive_flow.py | 2 | 1 | no | no | no |
...
| `core/services/runtime_learning_signals.py` | 🟢 LIVE | 261 | 5d | yes | core.services.runtime_action_outcome_tracking, core.services.runtime_decision_engine | 1 | test_runtime_learning_signals_smoke.py | 3 | 0 | no | no | no |
| `core/services/runtime_operational_memory.py` | 🟢 LIVE | 535 | 5d | yes | core.services.heartbeat_runtime, core.services.runtime_action_executor | 1 | test_runtime_executive_flow.py | 3 | 5 | no | no | no |
...
| `core/services/session_distillation.py` | 🟢 LIVE | 967 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.idle_consolidation | 5 | test_adaptive_decay.py, test_conflict_resolution.py, test_session_distillation.py | 15 | 16 | yes | no | no |
...
| `core/services/signal_decay_daemon.py` | 🟢 LIVE | 104 | 0d | yes | core.services.daemon_manager, core.services.heartbeat_runtime | 1 | test_signal_decay.py | 3 | 7 | yes | no | no |
...
| `core/services/signal_noise_guard.py` | 🟢 LIVE | 190 | 0d | yes | core.services.cadence_producers, core.services.development_focus_tracking, core.services.dream_hypothesis_signal_tracking | 1 | test_signal_noise_cleanup.py | 7 | 0 | no | no | no |
...
| `core/services/witness_signal_tracking.py` | 🟢 LIVE | 1007 | 0d | yes | apps.api.jarvis_api.routes.mission_control, core.services.autonomy_pressure_signal_tracking, core.services.cadence_producers | 2 | conftest.py, test_witness_daemon.py | 22 | 2 | yes | no | no |
