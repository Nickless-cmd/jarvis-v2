...
Sidst kørt: 2026-04-17T10:04:47+00:00  
Total services: 233
...
| `core/services/prompt_contract.py` | 3776 | 🟢 LIVE | 2d |
| `core/services/visible_model.py` | 1832 | 🟢 LIVE | 0d |
| `core/services/agent_runtime.py` | 1435 | 🟢 LIVE | 0d |
| `core/services/cheap_provider_runtime.py` | 1293 | 🟢 LIVE | 5d |
| `core/services/candidate_tracking.py` | 1208 | 🟢 LIVE | 10d |
| `core/services/runtime_cognitive_conductor.py` | 1181 | 🟢 LIVE | 3d |
| `core/services/prompt_evolution_runtime.py` | 1084 | 🟢 LIVE | 4d |
| `core/services/inner_voice_daemon.py` | 1078 | 🟢 LIVE | 3d |
...
|---|---|---:|---|---:|---|
| `core/services/completion_satisfaction.py` | ⚫ ORPHAN | 46 | 10d | 0 | no reachable path and no importers; no direct test imports |
| `core/services/decision_weight.py` | 🔴 SUSPICIOUS | 79 | 5d | 1 | not reachable from configured entry points |
| `core/services/runtime_action_registry.py` | ⚫ ORPHAN | 120 | 4d | 0 | no reachable path and no importers; no direct test imports |

## Fuld matrix

| Service | Score | Linjer | Sidst rørt | Reachable | Via | Tests | Testfiler | Imported by | Imports | Emits | Subscribes | Daemon |
|---|---|---:|---|---|---|---:|---|---:|---:|---|---|---|
| `core/services/absence_awareness.py` | 🟢 LIVE | 164 | 8d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cognitive_state_assembly, core.services.runtime_self_model | 1 | test_runtime_self_model.py | 4 | 1 | no | no | no |
...
| `core/services/affective_state_renderer.py` | 🟡 PARTIAL | 188 | 6d | yes | core.services.prompt_contract | 0 | — | 1 | 7 | no | no | no |
| `core/services/agent_runtime.py` | 🟢 LIVE | 1435 | 0d | yes | apps.api.jarvis_api.app, apps.api.jarvis_api.routes.mission_control, core.services.autonomous_council_daemon | 3 | test_agent_runtime_phase2.py, test_agent_runtime_phase3_scheduler.py, test_convene_council_tool.py | 9 | 7 | no | no | no |
...
| `core/services/apophenia_guard.py` | 🟡 PARTIAL | 80 | 10d | yes | apps.api.jarvis_api.routes.mission_control | 0 | — | 1 | 0 | no | no | no |
| `core/services/associative_recall.py` | 🟢 LIVE | 291 | 3d | yes | core.services.cognitive_state_assembly | 2 | test_associative_recall.py, test_jarvis_experimental.py | 3 | 4 | no | no | no |
...
| `core/services/attention_blink_test.py` | 🟢 LIVE | 153 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cognitive_core_experiments, core.services.heartbeat_runtime | 1 | test_consciousness_experiments.py | 4 | 3 | yes | no | no |
...
| `core/services/autonomous_council_daemon.py` | 🟢 LIVE | 296 | 0d | yes | core.services.daemon_manager, core.services.heartbeat_runtime, core.services.signal_surface_router | 1 | test_autonomous_council_daemon.py | 4 | 7 | yes | no | no |
...
| `core/services/boundary_awareness.py` | 🟡 PARTIAL | 43 | 10d | yes | apps.api.jarvis_api.routes.mission_control | 0 | — | 1 | 0 | no | no | no |
| `core/services/bounded_action_continuity_runtime.py` | 🟢 LIVE | 346 | 12d | yes | core.services.tool_intent_runtime | 1 | conftest.py | 2 | 1 | no | no | no |
...
| `core/services/bounded_workspace_write_runtime.py` | 🟡 PARTIAL | 196 | 13d | yes | core.services.tool_intent_runtime | 0 | — | 1 | 2 | no | no | no |
| `core/services/broadcast_daemon.py` | 🟢 LIVE | 165 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cognitive_core_experiments, core.services.heartbeat_runtime | 0 | — | 3 | 4 | yes | no | no |
...
| `core/services/cheap_provider_runtime.py` | 🟢 LIVE | 1293 | 5d | yes | core.cli.provider_config, core.services.agent_runtime, core.services.non_visible_lane_execution | 1 | conftest.py | 5 | 5 | yes | no | no |
| `core/services/chronicle_consolidation_brief_tracking.py` | 🟢 LIVE | 461 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.autonomy_pressure_signal_tracking, core.services.chronicle_consolidation_proposal_tracking | 1 | conftest.py | 9 | 6 | yes | no | no |
...
| `core/services/chronicle_consolidation_signal_tracking.py` | 🟢 LIVE | 537 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.chronicle_consolidation_brief_tracking, core.services.runtime_cognitive_conductor | 1 | conftest.py | 6 | 8 | yes | no | no |
| `core/services/chronicle_engine.py` | 🟢 LIVE | 178 | 10d | yes | apps.api.jarvis_api.routes.mission_control, core.services.development_narrative_daemon, core.services.heartbeat_runtime | 0 | — | 4 | 2 | yes | no | no |
...
| `core/services/cognitive_architecture_surface.py` | 🟢 LIVE | 37 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.runtime_self_model | 2 | test_mission_control_operations_route.py, test_runtime_self_model.py | 4 | 2 | no | no | no |
...
| `core/services/cognitive_state_narrativizer.py` | 🟡 PARTIAL | 239 | 2d | yes | core.services.cognitive_state_assembly, core.services.heartbeat_runtime | 0 | — | 2 | 0 | no | no | no |
...
| `core/services/completion_satisfaction.py` | ⚫ ORPHAN | 46 | 10d | no | — | 0 | — | 0 | 0 | no | no | no |
...
| `core/services/council_deliberation_controller.py` | 🟢 LIVE | 206 | 4d | yes | core.services.agent_runtime | 1 | test_deliberation_controller.py | 2 | 2 | yes | no | no |
| `core/services/council_memory_daemon.py` | 🟢 LIVE | 122 | 4d | yes | core.services.daemon_manager, core.services.heartbeat_runtime, core.services.signal_surface_router | 2 | test_council_memory_daemon.py, test_daemon_tools.py | 6 | 3 | yes | no | no |
| `core/services/council_memory_service.py` | 🟢 LIVE | 122 | 4d | yes | core.services.agent_runtime, core.services.autonomous_council_daemon, core.services.council_memory_daemon | 2 | test_council_memory_service.py, test_daemon_tools.py | 6 | 1 | no | no | no |
...
| `core/services/daemon_llm.py` | 🟢 LIVE | 167 | 3d | yes | core.services.aesthetic_taste_daemon, core.services.code_aesthetic_daemon, core.services.conflict_daemon | 4 | test_daemon_llm_cache.py, test_session_summaries.py, test_somatic_daemon.py | 20 | 3 | no | no | no |
...
| `core/services/decision_weight.py` | 🔴 SUSPICIOUS | 79 | 5d | no | — | 1 | test_decision_weight.py | 1 | 0 | no | no | no |
...
| `core/services/discord_config.py` | 🟡 PARTIAL | 38 | 6d | yes | core.services.discord_gateway, core.tools.simple_tools, scripts.jarvis | 0 | — | 3 | 1 | no | no | no |
...
| `core/services/dream_hypothesis_forced.py` | 🟢 LIVE | 74 | 3d | yes | core.services.heartbeat_runtime | 1 | test_jarvis_experimental.py | 2 | 1 | no | no | no |
...
| `core/services/embodied_state.py` | 🟢 LIVE | 369 | 15d | yes | apps.api.jarvis_api.routes.mission_control, core.services.adaptive_planner_runtime, core.services.adaptive_reasoning_runtime | 1 | conftest.py | 15 | 0 | no | no | no |
...
| `core/services/emergent_signal_tracking.py` | 🟢 LIVE | 442 | 15d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cadence_producers, core.services.dream_articulation | 1 | conftest.py | 12 | 7 | yes | no | no |
| `core/services/emotion_concepts.py` | 🟢 LIVE | 385 | 3d | yes | apps.api.jarvis_api.app, apps.api.jarvis_api.routes.mission_control, core.services.affective_meta_state | 3 | test_associative_recall.py, test_consciousness_experiments.py, test_emotion_concepts.py | 12 | 2 | no | no | no |
...
| `core/services/executive_contradiction_signal_tracking.py` | 🟢 LIVE | 520 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.chronicle_consolidation_brief_tracking, core.services.chronicle_consolidation_proposal_tracking | 1 | conftest.py | 9 | 2 | yes | no | no |
...
| `core/services/global_workspace.py` | 🟢 LIVE | 144 | 3d | yes | apps.api.jarvis_api.app, core.services.broadcast_daemon | 1 | test_consciousness_experiments.py | 3 | 1 | no | no | no |
...
| `core/services/hardware_body.py` | 🟡 PARTIAL | 145 | 6d | yes | apps.api.jarvis_api.routes.system_health, core.services.affective_state_renderer, core.services.heartbeat_runtime | 0 | — | 3 | 0 | no | no | no |
...
| `core/services/identity_composer.py` | 🟢 LIVE | 89 | 3d | yes | core.services.aesthetic_taste_daemon, core.services.code_aesthetic_daemon, core.services.cognitive_state_assembly | 1 | test_identity_composer.py | 21 | 5 | no | no | no |
...
| `core/services/inner_visible_support_signal_tracking.py` | 🟢 LIVE | 629 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.prompt_contract, core.services.signal_surface_router | 1 | conftest.py | 5 | 2 | yes | no | no |
| `core/services/inner_voice_daemon.py` | 🟢 LIVE | 1078 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.memory.inner_llm_enrichment, core.services.affective_meta_state | 1 | test_inner_voice_daemon.py | 12 | 13 | yes | no | no |
| `core/services/internal_cadence.py` | 🟢 LIVE | 431 | 10d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.runtime_self_model | 2 | conftest.py, test_internal_cadence.py | 5 | 8 | yes | no | no |
...
| `core/services/living_heartbeat_cycle.py` | 🟡 PARTIAL | 126 | 10d | yes | apps.api.jarvis_api.routes.mission_control, core.services.boredom_curiosity_bridge, core.services.cadence_producers | 0 | — | 9 | 0 | no | no | no |
...
| `core/services/memory_search.py` | 🟡 PARTIAL | 277 | 6d | yes | core.tools.simple_tools | 0 | — | 1 | 1 | no | no | no |
...
| `core/services/ollama_visible_prompt.py` | 🟡 PARTIAL | 94 | 7d | yes | core.services.visible_model, core.services.visible_runs | 0 | — | 2 | 0 | no | no | no |
...
| `core/services/orb_phase.py` | 🟡 PARTIAL | 22 | 2d | yes | core.services.visible_runs | 0 | — | 1 | 0 | no | no | no |
...
| `core/services/personality_vector.py` | 🟢 LIVE | 393 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.visible_runs | 1 | test_jarvis_experimental.py | 4 | 6 | yes | no | no |
...
| `core/services/private_temporal_curiosity_state_tracking.py` | 🟢 LIVE | 397 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.visible_runs | 1 | conftest.py | 3 | 2 | yes | no | no |
| `core/services/private_temporal_promotion_signal_tracking.py` | 🟢 LIVE | 448 | 19d | yes | apps.api.jarvis_api.routes.mission_control, core.services.chronicle_consolidation_brief_tracking, core.services.chronicle_consolidation_proposal_tracking | 1 | conftest.py | 7 | 2 | yes | no | no |
...
| `core/services/prompt_contract.py` | 🟢 LIVE | 3776 | 2d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.visible_model | 6 | conftest.py, test_attention_budget.py, test_context_compact.py | 9 | 56 | no | no | no |
...
| `core/services/runtime_action_executor.py` | 🟢 LIVE | 412 | 4d | yes | core.services.heartbeat_runtime | 1 | test_runtime_executive_flow.py | 2 | 12 | yes | no | no |
| `core/services/runtime_action_outcome_tracking.py` | 🟢 LIVE | 118 | 4d | yes | core.services.heartbeat_runtime | 1 | test_runtime_executive_flow.py | 2 | 4 | yes | no | no |
| `core/services/runtime_action_registry.py` | ⚫ ORPHAN | 120 | 4d | no | — | 0 | — | 0 | 0 | no | no | no |
...
| `core/services/runtime_browser_body.py` | 🟢 LIVE | 167 | 2d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.runtime_awareness_signal_tracking | 5 | test_browser_tools.py, test_heartbeat_execute_actions.py, test_mission_control_runtime_work.py | 11 | 2 | no | no | no |
| `core/services/runtime_cognitive_conductor.py` | 🟢 LIVE | 1181 | 3d | yes | apps.api.jarvis_api.routes.mission_control, core.services.attention_budget, core.services.cognitive_state_assembly | 1 | test_cognitive_conductor.py | 9 | 33 | no | no | no |
...
| `core/services/runtime_learning_signals.py` | 🟡 PARTIAL | 261 | 4d | yes | core.services.runtime_action_outcome_tracking, core.services.runtime_decision_engine | 0 | — | 2 | 0 | no | no | no |
...
| `core/services/runtime_resource_signal.py` | 🟡 PARTIAL | 108 | 9d | yes | core.services.prompt_contract | 0 | — | 1 | 1 | no | no | no |
...
| `core/services/self_compassion.py` | 🟡 PARTIAL | 56 | 10d | yes | apps.api.jarvis_api.routes.mission_control | 0 | — | 1 | 0 | no | no | no |
| `core/services/self_deception_guard.py` | 🟢 LIVE | 278 | 10d | yes | apps.api.jarvis_api.routes.mission_control, core.services.epistemic_runtime_state, core.services.prompt_contract | 1 | test_self_deception_guard.py | 4 | 0 | no | no | no |
...
| `core/services/self_model_signal_tracking.py` | 🟢 LIVE | 522 | 9d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cadence_producers, core.services.prompt_contract | 0 | — | 9 | 3 | yes | no | no |
...
| `core/services/signal_surface_router.py` | 🟢 LIVE | 265 | 4d | yes | core.services.autonomous_council_daemon, core.services.identity_composer, core.tools.simple_tools | 1 | test_signal_surface_router.py | 4 | 64 | no | no | no |
...
| `core/services/subjective_time.py` | 🟡 PARTIAL | 30 | 10d | yes | core.services.cognitive_state_assembly | 0 | — | 1 | 0 | no | no | no |
...
| `core/services/temporal_context.py` | 🟡 PARTIAL | 57 | 10d | yes | apps.api.jarvis_api.routes.mission_control | 0 | — | 1 | 1 | no | no | no |
...
| `core/services/tiktok_research_daemon.py` | 🟢 LIVE | 229 | 1d | yes | core.services.daemon_manager, core.services.heartbeat_runtime | 1 | test_tiktok_research_daemon.py | 3 | 1 | no | no | no |
...
| `core/services/tool_intent_approval_runtime.py` | 🟢 LIVE | 536 | 12d | yes | apps.api.jarvis_api.routes.mission_control, core.services.tool_intent_runtime | 1 | conftest.py | 3 | 2 | no | no | no |
| `core/services/tool_intent_runtime.py` | 🟢 LIVE | 824 | 12d | yes | apps.api.jarvis_api.routes.mission_control, core.services.heartbeat_runtime, core.services.runtime_self_model | 1 | conftest.py | 4 | 8 | no | no | no |
...
| `core/services/user_theory_of_mind.py` | 🟡 PARTIAL | 92 | 10d | yes | apps.api.jarvis_api.routes.mission_control, core.services.cognitive_state_assembly | 0 | — | 2 | 1 | no | no | no |
...
| `core/services/voice_daemon.py` | 🟡 PARTIAL | 81 | 4d | yes | apps.api.jarvis_api.app | 0 | — | 1 | 0 | no | no | no |
