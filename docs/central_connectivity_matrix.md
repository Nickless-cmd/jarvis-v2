...
**811 services** · 73 bridge-familier. Fordeling:

| Kvadrant | Antal | Betydning |
|----------|-------|-----------|
| KOBLET | 243 | direkte central-kald ELLER event-family der bridges |
| FRAKOBLET+LLM | 45 | **spilder: LLM-kald uden central-binding (§3, høj prio)** |
| FRAKOBLET+DARK | 219 | emitterer events hvis family INGEN rute har → signal tabt |
| FRAKOBLET-STILLE | 304 | ingen binding/LLM/events → ren utility (oftest OK) |
...
| `end_of_run_memory_consolidation` | ✓ | — | — |
...
| `visible_followup` | ✓ | — | ✓ |
| `visible_model` | ✓ | — | ✓ |
| `visible_runs` | ✓ | channel, cost, runtime, tool | ✓ |
...
| `dream_motif_daemon` | — |
| `existential_wonder_daemon` | existential_wonder |
...
| `identity_drift_proposer` | identity_drift, identity_drift_proposer |
...
| `memory_recall_telemetry` | memory, memory_recall_telemetry |
