...
> Generated 2026-09-24 from app.routes (live) — 616 routes. Regenerate: `python scripts/api_reference_gen.py`. DO NOT hand-edit.
...
| GET | `/central/profiles` | dict | central_profiles |
...
| GET | `/chat/approvals/pending` | dict | chat |
...
| GET | `/chat/sessions/{session_id}/pending-approval` | dict | chat |
| GET | `/chat/sessions/{session_id}/permission` | dict | chat |
| POST | `/chat/sessions/{session_id}/permission` | dict | chat |
| GET | `/chat/sessions/{session_id}/recovery` | dict | chat |
| PUT | `/chat/sessions/{session_id}/rename` | dict | chat |
| POST | `/chat/sessions/{session_id}/rewind` | dict | chat_rewind |
...
| POST | `/composer/choice` | dict | composer_suggest_routes |
| GET | `/composer/moenster` | dict | composer_suggest_routes |
...
| POST | `/workbench/messages/{message_id}/undo` | dict | workbench |
