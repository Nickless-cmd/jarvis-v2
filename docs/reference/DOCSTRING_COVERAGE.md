...
Generated from source. 8071/15562 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/decision_enforcement.py` :: `subscribe` (L550)
...
- `core/services/runtime_self_model_surfaces.py` :: `build_action_router_prompt_section` (L1049)
- `core/services/runtime_self_model_surfaces.py` :: `build_anticipatory_action_prompt_section` (L817)
- `core/services/runtime_self_model_surfaces.py` :: `build_autonomous_work_prompt_section` (L921)
- `core/services/runtime_self_model_surfaces.py` :: `build_avoidance_detector_prompt_section` (L649)
- `core/services/runtime_self_model_surfaces.py` :: `build_calm_anchor_prompt_section` (L593)
- `core/services/runtime_self_model_surfaces.py` :: `build_collective_pulse_prompt_section` (L1033)
- `core/services/runtime_self_model_surfaces.py` :: `build_creative_impulse_prompt_section` (L969)
- `core/services/runtime_self_model_surfaces.py` :: `build_creative_instinct_prompt_section` (L905)
- `core/services/runtime_self_model_surfaces.py` :: `build_creative_projects_prompt_section` (L617)
- `core/services/runtime_self_model_surfaces.py` :: `build_cross_session_threads_prompt_section` (L833)
- `core/services/runtime_self_model_surfaces.py` :: `build_day_shape_memory_prompt_section` (L633)
- `core/services/runtime_self_model_surfaces.py` :: `build_deep_reflection_prompt_section` (L1097)
- `core/services/runtime_self_model_surfaces.py` :: `build_desperation_awareness_prompt_section` (L577)
- `core/services/runtime_self_model_surfaces.py` :: `build_developmental_valence_prompt_section` (L561)
- `core/services/runtime_self_model_surfaces.py` :: `build_dream_consolidation_prompt_section` (L937)
- `core/services/runtime_self_model_surfaces.py` :: `build_file_watch_prompt_section` (L769)
- `core/services/runtime_self_model_surfaces.py` :: `build_infra_weather_prompt_section` (L857)
- `core/services/runtime_self_model_surfaces.py` :: `build_memory_density_prompt_section` (L1081)
- `core/services/runtime_self_model_surfaces.py` :: `build_memory_write_policy_prompt_section` (L689)
- `core/services/runtime_self_model_surfaces.py` :: `build_mortality_awareness_prompt_section` (L1001)
- `core/services/runtime_self_model_surfaces.py` :: `build_prompt_mutation_loop_prompt_section` (L753)
- `core/services/runtime_self_model_surfaces.py` :: `build_proprioception_metrics_prompt_section` (L801)
- `core/services/runtime_self_model_surfaces.py` :: `build_reboot_awareness_prompt_section` (L785)
- `core/services/runtime_self_model_surfaces.py` :: `build_relation_dynamics_prompt_section` (L889)
- `core/services/runtime_self_model_surfaces.py` :: `build_relational_warmth_prompt_section` (L1017)
- `core/services/runtime_self_model_surfaces.py` :: `build_shadow_scan_prompt_section` (L985)
- `core/services/runtime_self_model_surfaces.py` :: `build_spaced_repetition_prompt_section` (L705)
- `core/services/runtime_self_model_surfaces.py` :: `build_sustained_attention_prompt_section` (L1065)
- `core/services/runtime_self_model_surfaces.py` :: `build_temporal_rhythm_prompt_section` (L873)
- `core/services/runtime_self_model_surfaces.py` :: `build_text_resonance_prompt_section` (L953)
- `core/services/runtime_self_model_surfaces.py` :: `build_thought_thread_prompt_section` (L665)
- `core/services/runtime_self_model_surfaces.py` :: `build_valence_trajectory_prompt_section` (L545)
