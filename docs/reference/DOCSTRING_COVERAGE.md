...
Generated from source. 6993/13865 functions/methods documented (50%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
| `apps.api.jarvis_api.routes` | 609 | 801 | 76% |
...
- `core/services/agent_runtime_spawn.py` :: `cancel_agent` (L1185)
- `core/services/agent_runtime_spawn.py` :: `execute_agent_task` (L439)
- `core/services/agent_runtime_spawn.py` :: `expire_agent` (L1240)
- `core/services/agent_runtime_spawn.py` :: `resume_agent` (L1221)
- `core/services/agent_runtime_spawn.py` :: `run_due_agent_schedules` (L1057)
- `core/services/agent_runtime_spawn.py` :: `schedule_agent_task` (L821)
- `core/services/agent_runtime_spawn.py` :: `send_message_to_agent` (L761)
- `core/services/agent_runtime_spawn.py` :: `send_peer_message` (L789)
- `core/services/agent_runtime_spawn.py` :: `spawn_agent_task` (L92)
- `core/services/agent_runtime_spawn.py` :: `suspend_agent` (L1204)
...
- `core/services/chat_sessions.py` :: `delete_chat_session` (L952)
- `core/services/chat_sessions.py` :: `get_chat_session` (L335)
- `core/services/chat_sessions.py` :: `recent_chat_session_messages` (L663)
- `core/services/chat_sessions.py` :: `recent_chat_tool_messages` (L913)
- `core/services/chat_sessions.py` :: `rename_chat_session` (L938)
...
- `core/services/cheap_provider_runtime_adapters.py` :: `provider_runtime_defaults` (L102)
- `core/services/cheap_provider_runtime_adapters.py` :: `supported_cheap_providers` (L92)
...
- `core/services/connectors.py` :: `set_enabled` (L188)
...
- `core/services/prompt_contract.py` :: `build_future_agent_task_prompt_assembly` (L3394)
- `core/services/prompt_contract.py` :: `build_heartbeat_prompt_assembly` (L3242)
- `core/services/prompt_contract.py` :: `build_prompt_relevance_decision` (L3531)
...
- `core/services/prompt_contract.py` :: `prompt_mode_loader_summary` (L4749)
...
- `core/services/run_closure_gate.py` :: `stop_run_closure_gate` (L686)
...
- `core/services/tool_result_store.py` :: `build_tool_result_reference` (L89)
- `core/services/tool_result_store.py` :: `cleanup_old_results` (L72)
- `core/services/tool_result_store.py` :: `get_tool_result` (L56)
- `core/services/tool_result_store.py` :: `parse_tool_result_reference` (L101)
- `core/services/tool_result_store.py` :: `render_tool_result_for_prompt` (L122)
...
- `core/services/visible_followup_adapters.py` :: `CodexFollowupAdapter.stream_followup` (L1274)
...
- `core/services/visible_followup_events.py` :: `FollowupAdapter.stream_followup` (L170)
...
- `core/services/visible_runs.py` :: `VisibleRunController.attach_stream` (L377)
- `core/services/visible_runs.py` :: `VisibleRunController.cancel` (L383)
- `core/services/visible_runs.py` :: `VisibleRunController.clear_stream` (L380)
- `core/services/visible_runs.py` :: `VisibleRunController.is_cancelled` (L390)
- `core/services/visible_runs.py` :: `cancel_visible_run` (L6579)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L6604)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L6808)
- `core/services/visible_runs.py` :: `get_last_visible_execution_trace` (L6817)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L6804)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L6575)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L6717)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L6769)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L6686)
- `core/services/visible_runs.py` :: `get_visible_work` (L6627)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L6659)
- `core/services/visible_runs.py` :: `register_visible_run` (L6545)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L6827)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L6590)
...
- `scripts/commit_with_attribution.py` :: `main` (L37)
