...
Generated from source. 7690/14904 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
## Undocumented public functions (2127)
...
- `core/services/cheap_provider_runtime_selection.py` :: `execute_public_safe_cheap_lane` (L949)
...
- `core/services/visible_runs.py` :: `cancel_visible_run` (L7121)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L7146)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L7350)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L7346)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L7117)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L7259)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L7311)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L7228)
- `core/services/visible_runs.py` :: `get_visible_work` (L7169)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L7201)
- `core/services/visible_runs.py` :: `register_visible_run` (L7079)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L7367)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L7132)
