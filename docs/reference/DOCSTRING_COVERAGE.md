...
Generated from source. 7589/14726 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
| `apps.api.jarvis_api.routes` | 637 | 832 | 76% |
...
- `apps/api/jarvis_api/app.py` :: `create_app` (L205)
