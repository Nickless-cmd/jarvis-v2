...
Generated from source. 6884/13721 functions/methods documented (50%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
| `apps.api.jarvis_api.routes` | 607 | 799 | 75% |
...
| `core.services` | 4572 | 9502 | 48% |
| `core.services.decision_triggers` | 0 | 3 | 0% |
| `core.services.prompt_sections` | 101 | 175 | 57% |
| `core.services.trading` | 4 | 20 | 20% |
| `core.services.visible_runs_sections` | 14 | 26 | 53% |
| `core.skills` | 0 | 0 | 0% |
| `core.skills.voice` | 39 | 49 | 79% |
| `core.tools` | 389 | 847 | 45% |
...
- `core/runtime/settings.py` :: `RuntimeSettings.to_dict` (L504)
- `core/runtime/settings.py` :: `load_settings` (L609)
- `core/runtime/settings.py` :: `update_visible_execution_settings` (L1060)
...
- `core/services/agent_runtime_spawn.py` :: `cancel_agent` (L1128)
- `core/services/agent_runtime_spawn.py` :: `execute_agent_task` (L439)
- `core/services/agent_runtime_spawn.py` :: `expire_agent` (L1183)
- `core/services/agent_runtime_spawn.py` :: `resume_agent` (L1164)
- `core/services/agent_runtime_spawn.py` :: `run_due_agent_schedules` (L1000)
- `core/services/agent_runtime_spawn.py` :: `schedule_agent_task` (L764)
- `core/services/agent_runtime_spawn.py` :: `send_message_to_agent` (L704)
- `core/services/agent_runtime_spawn.py` :: `send_peer_message` (L732)
- `core/services/agent_runtime_spawn.py` :: `spawn_agent_task` (L92)
- `core/services/agent_runtime_spawn.py` :: `suspend_agent` (L1147)
...
- `core/services/visible_followup_adapters.py` :: `CodexFollowupAdapter.stream_followup` (L1237)
- `core/services/visible_followup_adapters.py` :: `OllamaFollowupAdapter.stream_followup` (L230)
- `core/services/visible_followup_adapters.py` :: `OpenAICompatFollowupAdapter.stream_followup` (L770)
...
- `core/services/visible_runs.py` :: `VisibleRunController.attach_stream` (L348)
...
- `core/services/visible_runs.py` :: `cancel_visible_run` (L6618)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L6643)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L6847)
- `core/services/visible_runs.py` :: `get_last_visible_execution_trace` (L6856)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L6843)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L6614)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L6756)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L6808)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L6725)
- `core/services/visible_runs.py` :: `get_visible_work` (L6666)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L6698)
- `core/services/visible_runs.py` :: `register_visible_run` (L6584)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L6866)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L6629)
