...
Generated from source. 6217/12734 functions/methods documented (48%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
## Undocumented public functions (1837)
...
- `core/services/cluster_daemon_families.py` :: `relation_family` (L658)
...
- `core/services/daemon_manager.py` :: `get_daemon_names` (L705)
- `core/services/daemon_manager.py` :: `set_daemon_enabled` (L752)
