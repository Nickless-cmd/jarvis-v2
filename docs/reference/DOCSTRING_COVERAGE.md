...
Generated from source. 6502/13038 functions/methods documented (49%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/cache_maintenance_daemon.py` :: `build_cache_maintenance_surface` (L169)
- `core/services/cache_maintenance_daemon.py` :: `get_cache_maintenance_stats` (L162)
