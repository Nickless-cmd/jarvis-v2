...
Generated from source. 6504/13040 functions/methods documented (49%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
## Undocumented public functions (1845)
...
- `core/services/cache_maintenance_daemon.py` :: `build_cache_maintenance_surface` (L176)
- `core/services/cache_maintenance_daemon.py` :: `get_cache_maintenance_stats` (L169)
...
- `core/services/dream_consolidation_daemon.py` :: `build_dream_consolidation_surface` (L690)
- `core/services/dream_consolidation_daemon.py` :: `list_recent_dreams` (L686)
