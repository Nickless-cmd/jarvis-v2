...
Generated from source. 5769/12108 functions/methods documented (47%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
| `apps.api.jarvis_api.routes` | 534 | 713 | 74% |
...
- `core/services/chat_sessions.py` :: `append_chat_message` (L323)
- `core/services/chat_sessions.py` :: `create_chat_session` (L15)
- `core/services/chat_sessions.py` :: `delete_chat_session` (L751)
- `core/services/chat_sessions.py` :: `get_chat_session` (L258)
- `core/services/chat_sessions.py` :: `recent_chat_session_messages` (L463)
- `core/services/chat_sessions.py` :: `recent_chat_tool_messages` (L712)
- `core/services/chat_sessions.py` :: `rename_chat_session` (L737)
...
- `core/services/prompt_contract.py` :: `build_future_agent_task_prompt_assembly` (L2578)
- `core/services/prompt_contract.py` :: `build_heartbeat_prompt_assembly` (L2426)
- `core/services/prompt_contract.py` :: `build_prompt_relevance_decision` (L2715)
...
- `core/services/prompt_contract.py` :: `prompt_mode_loader_summary` (L4194)
