...
- `core/services/chat_sessions.py` :: `delete_chat_session` (L754)
- `core/services/chat_sessions.py` :: `get_chat_session` (L258)
- `core/services/chat_sessions.py` :: `recent_chat_session_messages` (L466)
- `core/services/chat_sessions.py` :: `recent_chat_tool_messages` (L715)
- `core/services/chat_sessions.py` :: `rename_chat_session` (L740)
