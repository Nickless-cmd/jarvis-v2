...
- `core/services/visible_runs.py` :: `cancel_visible_run` (L7135)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L7160)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L7364)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L7360)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L7131)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L7273)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L7325)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L7242)
- `core/services/visible_runs.py` :: `get_visible_work` (L7183)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L7215)
- `core/services/visible_runs.py` :: `register_visible_run` (L7093)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L7381)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L7146)
