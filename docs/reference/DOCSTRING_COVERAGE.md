...
Generated from source. 7827/15213 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/chat_sessions.py` :: `append_chat_message` (L632)
- `core/services/chat_sessions.py` :: `create_chat_session` (L63)
- `core/services/chat_sessions.py` :: `delete_chat_session` (L1324)
- `core/services/chat_sessions.py` :: `get_chat_session` (L541)
- `core/services/chat_sessions.py` :: `recent_chat_session_messages` (L1004)
- `core/services/chat_sessions.py` :: `recent_chat_tool_messages` (L1285)
- `core/services/chat_sessions.py` :: `rename_chat_session` (L1310)
