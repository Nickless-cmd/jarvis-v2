...
- `core/services/chat_sessions.py` :: `append_chat_message` (L539)
- `core/services/chat_sessions.py` :: `create_chat_session` (L54)
- `core/services/chat_sessions.py` :: `delete_chat_session` (L1212)
- `core/services/chat_sessions.py` :: `get_chat_session` (L472)
- `core/services/chat_sessions.py` :: `recent_chat_session_messages` (L892)
- `core/services/chat_sessions.py` :: `recent_chat_tool_messages` (L1173)
- `core/services/chat_sessions.py` :: `rename_chat_session` (L1198)
