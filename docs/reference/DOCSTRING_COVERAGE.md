...
Generated from source. 7971/15437 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `apps/api/jarvis_api/routes/presence.py` :: `notifications_ack` (L73)
- `apps/api/jarvis_api/routes/presence.py` :: `notifications_pending` (L65)
- `apps/api/jarvis_api/routes/presence.py` :: `presence_debug` (L106)
...
- `apps/central_cli/central_cli/hud.py` :: `CentralHud.compose` (L280)
- `apps/central_cli/central_cli/hud.py` :: `CentralHud.on_mount` (L305)
- `apps/central_cli/central_cli/hud.py` :: `CentralHud.refresh_data` (L474)
- `apps/central_cli/central_cli/hud.py` :: `CentralHud.show_tab` (L363)
- `apps/central_cli/central_cli/hud.py` :: `run_hud` (L594)
...
- `apps/voice_agent/agent.py` :: `JarvisMarkoer.chat` (L139)
- `apps/voice_agent/agent.py` :: `JarvisStemme.llm_node` (L198)
- `apps/voice_agent/agent.py` :: `WhisperSTT.varm_op` (L86)
- `apps/voice_agent/agent.py` :: `entrypoint` (L256)
- `apps/voice_agent/agent.py` :: `main` (L305)
- `apps/voice_agent/proeve.py` :: `afspil` (L40)
- `apps/voice_agent/proeve.py` :: `main` (L51)
- `apps/voice_agent/proeve.py` :: `stilhed` (L47)
- `apps/voice_agent/proeve.py` :: `t` (L27)
- `apps/voice_agent/proeve.py` :: `tale` (L31)
...
- `core/auth/profiles.py` :: `get_provider_auth_material_kind` (L241)
- `core/auth/profiles.py` :: `get_provider_callback_intent_consistency` (L419)
- `core/auth/profiles.py` :: `get_provider_callback_validation_state` (L363)
- `core/auth/profiles.py` :: `get_provider_credentials` (L197)
- `core/auth/profiles.py` :: `get_provider_exchange_readiness` (L388)
- `core/auth/profiles.py` :: `get_provider_launch_freshness` (L334)
- `core/auth/profiles.py` :: `get_provider_launch_result_state` (L311)
- `core/auth/profiles.py` :: `get_provider_oauth_state` (L274)
- `core/auth/profiles.py` :: `get_provider_state` (L100)
- `core/auth/profiles.py` :: `get_provider_state_view` (L108)
- `core/auth/profiles.py` :: `list_auth_profiles` (L35)
- `core/auth/profiles.py` :: `provider_has_real_credentials` (L211)
- `core/auth/profiles.py` :: `revoke_provider` (L457)
- `core/auth/profiles.py` :: `save_provider_credentials` (L67)
...
- `core/cli/capability_commands.py` :: `execute_capability_request_truth` (L112)
...
- `core/runtime/db_visible.py` :: `record_visible_work_note` (L239)
- `core/runtime/db_visible.py` :: `visible_session_continuity` (L347)
...
- `core/runtime/settings.py` :: `RuntimeSettings.to_dict` (L569)
- `core/runtime/settings.py` :: `load_settings` (L619)
- `core/runtime/settings.py` :: `update_visible_execution_settings` (L1089)
...
- `core/services/agent_runtime_spawn.py` :: `cancel_agent` (L1333)
- `core/services/agent_runtime_spawn.py` :: `expire_agent` (L1388)
- `core/services/agent_runtime_spawn.py` :: `resume_agent` (L1369)
- `core/services/agent_runtime_spawn.py` :: `run_due_agent_schedules` (L1196)
- `core/services/agent_runtime_spawn.py` :: `schedule_agent_task` (L953)
- `core/services/agent_runtime_spawn.py` :: `send_message_to_agent` (L893)
- `core/services/agent_runtime_spawn.py` :: `send_peer_message` (L921)
- `core/services/agent_runtime_spawn.py` :: `spawn_agent_task` (L92)
- `core/services/agent_runtime_spawn.py` :: `suspend_agent` (L1352)
...
- `core/services/ambient_sound_daemon.py` :: `build_ambient_sound_surface` (L335)
...
- `core/services/approval_bridge_shadow.py` :: `taellere` (L41)
...
- `core/services/attachment_topology_signal_tracking.py` :: `track_runtime_attachment_topology_signals_for_visible_turn` (L44)
- `core/services/attention_budget.py` :: `AttentionTrace.included_sections` (L140)
...
- `core/services/autonomous_run_failures.py` :: `clear` (L149)
- `core/services/autonomous_run_failures.py` :: `mark_retried` (L141)
- `core/services/autonomous_run_failures.py` :: `pending_retries` (L137)
...
- `core/services/cheap_provider_runtime_selection.py` :: `test_provider_target` (L145)
...
- `core/services/conflict_resolution.py` :: `build_conflict_resolution_surface` (L615)
...
- `core/services/device_presence.py` :: `prune` (L307)
- `core/services/device_presence.py` :: `rank` (L237)
- `core/services/device_presence.py` :: `record_ping` (L144)
- `core/services/device_presence.py` :: `summary` (L320)
...
- `core/services/dream_consolidation_daemon.py` :: `build_dream_consolidation_surface` (L858)
- `core/services/dream_consolidation_daemon.py` :: `list_recent_dreams` (L854)
...
- `core/services/heartbeat_runtime.py` :: `load_heartbeat_policy` (L2300)
...
- `core/services/hollow_promise_round.py` :: `note_detected` (L58)
- `core/services/hollow_promise_round.py` :: `supports_forced_tool_choice` (L33)
...
- `core/services/in_flight_runs.py` :: `renew_recovery_lease` (L620)
...
- `core/services/invocation_record.py` :: `taellere` (L37)
...
- `core/services/living_executive.py` :: `build_living_executive_surface` (L83)
...
- `core/services/living_executive.py` :: `start_listener` (L863)
- `core/services/living_executive.py` :: `stop_listener` (L884)
...
- `core/services/loyalty_gradient_signal_tracking.py` :: `build_runtime_loyalty_gradient_signal_surface` (L95)
- `core/services/loyalty_gradient_signal_tracking.py` :: `refresh_runtime_loyalty_gradient_signal_statuses` (L91)
- `core/services/loyalty_gradient_signal_tracking.py` :: `track_runtime_loyalty_gradient_signals_for_visible_turn` (L43)
...
- `core/services/notifikations_emittere.py` :: `paa_godkendelse` (L82)
- `core/services/notifikations_emittere.py` :: `paa_koersel_faerdig` (L98)
...
- `core/services/perceptual_event_engine.py` :: `build_perception_prompt_section` (L332)
- `core/services/perceptual_event_engine.py` :: `build_perception_surface` (L320)
...
- `core/services/private_initiative_tension_signal_tracking.py` :: `track_runtime_private_initiative_tension_signals_for_visible_turn` (L36)
- `core/services/private_inner_interplay_signal_tracking.py` :: `build_runtime_private_inner_interplay_signal_surface` (L73)
- `core/services/private_inner_interplay_signal_tracking.py` :: `refresh_runtime_private_inner_interplay_signal_statuses` (L69)
- `core/services/private_inner_interplay_signal_tracking.py` :: `track_runtime_private_inner_interplay_signals_for_visible_turn` (L35)
- `core/services/private_inner_note_signal_tracking.py` :: `build_runtime_private_inner_note_signal_surface` (L77)
- `core/services/private_inner_note_signal_tracking.py` :: `refresh_runtime_private_inner_note_signal_statuses` (L73)
- `core/services/private_inner_note_signal_tracking.py` :: `track_runtime_private_inner_note_signals_for_visible_turn` (L38)
...
- `core/services/prompt_contract.py` :: `build_future_agent_task_prompt_assembly` (L3513)
- `core/services/prompt_contract.py` :: `build_heartbeat_prompt_assembly` (L3361)
- `core/services/prompt_contract.py` :: `build_prompt_relevance_decision` (L3650)
...
- `core/services/self_model_signal_tracking.py` :: `track_runtime_self_model_signals_for_visible_turn` (L28)
...
- `core/services/self_wakeup.py` :: `list_wakeups` (L240)
...
- `core/services/stream_settlement.py` :: `AttemptLedger.frames` (L271)
- `core/services/stream_settlement.py` :: `AttemptLedger.is_settled` (L289)
- `core/services/stream_settlement.py` :: `AttemptLedger.settled` (L286)
...
- `core/services/turn_tail_timing.py` :: `start` (L42)
...
- `core/services/user_understanding_signal_tracking.py` :: `build_runtime_user_understanding_signal_surface` (L79)
- `core/services/user_understanding_signal_tracking.py` :: `refresh_runtime_user_understanding_signal_statuses` (L75)
...
- `core/services/visible_followup_adapters.py` :: `CodexFollowupAdapter.stream_followup` (L1307)
- `core/services/visible_followup_adapters.py` :: `OllamaFollowupAdapter.stream_followup` (L243)
- `core/services/visible_followup_adapters.py` :: `OpenAICompatFollowupAdapter.stream_followup` (L809)
...
- `core/services/visible_model_adapters.py` :: `visible_execution_readiness` (L702)
...
- `core/services/visible_runs.py` :: `VisibleRunController.attach_stream` (L534)
- `core/services/visible_runs.py` :: `VisibleRunController.cancel` (L540)
- `core/services/visible_runs.py` :: `VisibleRunController.clear_stream` (L537)
- `core/services/visible_runs.py` :: `VisibleRunController.is_cancelled` (L547)
- `core/services/visible_runs.py` :: `cancel_visible_run` (L7230)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L7255)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L7459)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L7455)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L7226)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L7368)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L7420)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L7337)
- `core/services/visible_runs.py` :: `get_visible_work` (L7278)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L7310)
- `core/services/visible_runs.py` :: `register_visible_run` (L7188)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L7476)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L7241)
...
- `scripts/interlanguage_llm_judge.py` :: `main` (L225)
- `scripts/interlanguage_llm_judge.py` :: `run_alpha` (L110)
...
- `scripts/memory_probe.py` :: `format_report` (L140)
...
- `scripts/phase6_analyze.py` :: `centroid` (L64)
- `scripts/phase6_analyze.py` :: `cos` (L57)
- `scripts/phase6_analyze.py` :: `embed` (L39)
- `scripts/phase6_analyze.py` :: `main` (L69)
- `scripts/phase6_collect.py` :: `run` (L133)
- `scripts/phase7_analyze.py` :: `analyze` (L61)
- `scripts/phase7_analyze.py` :: `bootstrap_low` (L53)
- `scripts/phase7_analyze.py` :: `paired_diffs` (L44)
- `scripts/phase7_build_probes.py` :: `identity_text` (L98)
- `scripts/phase7_build_probes.py` :: `main` (L171)
...
- `scripts/verify_guard_tests.py` :: `main` (L69)
- `scripts/verify_history_reads.py` :: `fund_i_fil` (L54)
- `scripts/verify_history_reads.py` :: `main` (L92)
- `scripts/verify_notes.py` :: `fejl_i` (L50)
