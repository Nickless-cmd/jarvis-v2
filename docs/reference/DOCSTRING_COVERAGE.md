...
Generated from source. 8060/15552 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `apps/api/jarvis_api/routes/notifikationer.py` :: `afgoer` (L123)
- `apps/api/jarvis_api/routes/notifikationer.py` :: `set_` (L170)
...
- `core/services/prompt_contract.py` :: `build_future_agent_task_prompt_assembly` (L3527)
- `core/services/prompt_contract.py` :: `build_heartbeat_prompt_assembly` (L3375)
- `core/services/prompt_contract.py` :: `build_prompt_relevance_decision` (L3664)
...
- `core/services/prompt_contract.py` :: `prompt_mode_loader_summary` (L4900)
