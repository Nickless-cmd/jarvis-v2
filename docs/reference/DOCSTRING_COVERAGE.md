...
Generated from source. 7502/14618 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/visible_runs.py` :: `VisibleRunController.attach_stream` (L447)
- `core/services/visible_runs.py` :: `VisibleRunController.cancel` (L453)
- `core/services/visible_runs.py` :: `VisibleRunController.clear_stream` (L450)
- `core/services/visible_runs.py` :: `VisibleRunController.is_cancelled` (L460)
- `core/services/visible_runs.py` :: `cancel_visible_run` (L6844)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L6869)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L7073)
- `core/services/visible_runs.py` :: `get_last_visible_execution_trace` (L7082)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L7069)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L6840)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L6982)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L7034)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L6951)
- `core/services/visible_runs.py` :: `get_visible_work` (L6892)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L6924)
- `core/services/visible_runs.py` :: `register_visible_run` (L6802)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L7092)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L6855)
- `core/services/visible_runs_learning_signals.py` :: `record_visible_run_learning_signals` (L53)
- `core/services/visible_runs_outcomes.py` :: `set_last_visible_run_outcome` (L518)
