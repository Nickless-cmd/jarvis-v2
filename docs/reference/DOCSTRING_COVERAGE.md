...
- `core/services/cheap_provider_runtime_adapters.py` :: `list_provider_models` (L536)
- `core/services/cheap_provider_runtime_adapters.py` :: `provider_auth_ready` (L500)
- `core/services/cheap_provider_runtime_adapters.py` :: `provider_runtime_defaults` (L481)
- `core/services/cheap_provider_runtime_adapters.py` :: `supported_cheap_providers` (L471)
