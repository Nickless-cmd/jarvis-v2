...
Generated from source. 7945/15405 functions/methods documented (51%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/chat_sessions.py` :: `append_chat_message` (L736)
- `core/services/chat_sessions.py` :: `create_chat_session` (L64)
- `core/services/chat_sessions.py` :: `delete_chat_session` (L1444)
- `core/services/chat_sessions.py` :: `recent_chat_session_messages` (L1120)
- `core/services/chat_sessions.py` :: `recent_chat_tool_messages` (L1405)
- `core/services/chat_sessions.py` :: `rename_chat_session` (L1430)
...
- `core/services/prompt_contract.py` :: `build_future_agent_task_prompt_assembly` (L3495)
- `core/services/prompt_contract.py` :: `build_heartbeat_prompt_assembly` (L3343)
- `core/services/prompt_contract.py` :: `build_prompt_relevance_decision` (L3632)
...
- `core/services/prompt_contract.py` :: `prompt_mode_loader_summary` (L4850)
...
- `core/services/visible_runs.py` :: `VisibleRunController.attach_stream` (L470)
- `core/services/visible_runs.py` :: `VisibleRunController.cancel` (L476)
- `core/services/visible_runs.py` :: `VisibleRunController.clear_stream` (L473)
- `core/services/visible_runs.py` :: `VisibleRunController.is_cancelled` (L483)
- `core/services/visible_runs.py` :: `cancel_visible_run` (L7122)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L7147)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L7351)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L7347)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L7118)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L7260)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L7312)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L7229)
- `core/services/visible_runs.py` :: `get_visible_work` (L7170)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L7202)
- `core/services/visible_runs.py` :: `register_visible_run` (L7080)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L7368)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L7133)
