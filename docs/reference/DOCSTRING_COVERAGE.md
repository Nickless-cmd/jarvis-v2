...
Generated from source. 6517/13075 functions/methods documented (49%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/dream_consolidation_daemon.py` :: `build_dream_consolidation_surface` (L691)
- `core/services/dream_consolidation_daemon.py` :: `list_recent_dreams` (L687)
