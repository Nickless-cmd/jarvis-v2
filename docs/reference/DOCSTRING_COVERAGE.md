...
Generated from source. 6226/12744 functions/methods documented (48%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
## Undocumented public functions (1838)
...
- `core/services/daemon_manager.py` :: `get_daemon_names` (L743)
- `core/services/daemon_manager.py` :: `set_daemon_enabled` (L790)
