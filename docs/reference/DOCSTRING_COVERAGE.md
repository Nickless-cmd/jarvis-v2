...
Generated from source. 6793/13574 functions/methods documented (50%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
- `core/services/visible_followup_adapters.py` :: `CodexFollowupAdapter.stream_followup` (L1214)
- `core/services/visible_followup_adapters.py` :: `OllamaFollowupAdapter.stream_followup` (L208)
- `core/services/visible_followup_adapters.py` :: `OpenAICompatFollowupAdapter.stream_followup` (L747)
...
- `core/services/visible_runs.py` :: `cancel_visible_run` (L6614)
- `core/services/visible_runs.py` :: `get_active_visible_run` (L6639)
- `core/services/visible_runs.py` :: `get_last_visible_capability_use` (L6843)
- `core/services/visible_runs.py` :: `get_last_visible_execution_trace` (L6852)
- `core/services/visible_runs.py` :: `get_last_visible_run_outcome` (L6839)
- `core/services/visible_runs.py` :: `get_visible_run_controller` (L6610)
- `core/services/visible_runs.py` :: `get_visible_selected_work_item` (L6752)
- `core/services/visible_runs.py` :: `get_visible_selected_work_note` (L6804)
- `core/services/visible_runs.py` :: `get_visible_selected_work_surface` (L6721)
- `core/services/visible_runs.py` :: `get_visible_work` (L6662)
- `core/services/visible_runs.py` :: `get_visible_work_surface` (L6694)
- `core/services/visible_runs.py` :: `register_visible_run` (L6580)
- `core/services/visible_runs.py` :: `set_last_visible_capability_use` (L6862)
- `core/services/visible_runs.py` :: `unregister_visible_run` (L6625)
...
- `core/tools/tool_scoping.py` :: `reset_tool_scope` (L187)
- `core/tools/tool_scoping.py` :: `set_local_exec` (L205)
- `core/tools/tool_scoping.py` :: `set_tool_scope` (L183)
- `core/tools/tool_scoping.py` :: `tool_scope` (L210)
