...
Generated from source. 7244/14240 functions/methods documented (50%). The list below is the **mangler** for functions — public (non-`_`) undocumented functions, the target of a future docstring gap-fill.
...
| `core.plugins` | 6 | 9 | 66% |
| `core.runtime` | 607 | 1115 | 54% |
| `core.services` | 4815 | 9822 | 49% |
...
- `core/services/prompt_contract.py` :: `build_future_agent_task_prompt_assembly` (L3458)
- `core/services/prompt_contract.py` :: `build_heartbeat_prompt_assembly` (L3306)
- `core/services/prompt_contract.py` :: `build_prompt_relevance_decision` (L3595)
...
- `core/services/prompt_contract.py` :: `prompt_mode_loader_summary` (L4813)
