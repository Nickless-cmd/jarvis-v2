...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 15372 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`apps.api.jarvis_api.routes.02`](apps.api.jarvis_api.routes.02.md) — `companion` … `openai_auth`
