...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 14531 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`core.runtime.02`](core.runtime.02.md) — `db_private_signals` … `run_profile`
- [`core.runtime.03`](core.runtime.03.md) — `runtime_json_io` … `workspace_paths`
