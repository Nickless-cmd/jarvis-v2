...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 12510 functions/methods, 48% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
