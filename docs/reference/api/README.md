...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 12041 functions/methods, 47% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`apps.api.jarvis_api.routes.01`](apps.api.jarvis_api.routes.01.md) — `__init__` … `jarvisx_common`
- [`apps.api.jarvis_api.routes.02`](apps.api.jarvis_api.routes.02.md) — `jarvisx_dispatches` … `users`
