...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 15218 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`scripts.02`](scripts.02.md) — `jarvis_bare_practice_runner` … `smoke_test_startup`
- [`scripts.03`](scripts.03.md) — `tag_untagged_skills` … `verify_fase_a`
