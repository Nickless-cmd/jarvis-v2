...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 13836 functions/methods, 50% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`core.tools.02`](core.tools.02.md) — `notification_tools` … `smart_outline`
- [`core.tools.03`](core.tools.03.md) — `speak_tool` … `world_model_tools`
