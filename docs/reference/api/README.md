...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 13697 functions/methods, 50% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`apps.api.jarvis_api.routes.03`](apps.api.jarvis_api.routes.03.md) — `users` … `workbench`
