...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 12065 functions/methods, 47% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
