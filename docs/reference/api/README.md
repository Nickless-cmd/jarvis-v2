...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 13887 functions/methods, 50% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`core.services.22`](core.services.22.md) — `subagent_ecology` … `tool_result_store`
- [`core.services.23`](core.services.23.md) — `tool_router` … `visible_model_ollama`
- [`core.services.24`](core.services.24.md) — `visible_model_prompt` … `world_model_signal_tracking`
