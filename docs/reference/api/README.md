...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 13023 functions/methods, 49% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`core.services.20`](core.services.20.md) — `skill_engine` … `theory_of_mind`
