...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 13234 functions/methods, 49% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`scripts.01`](scripts.01.md) — `__init__` … `migrate_emotional_memory`
- [`scripts.02`](scripts.02.md) — `mint_jarvisx_token` … `verify_fase_a`
