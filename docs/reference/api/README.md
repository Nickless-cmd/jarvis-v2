...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 13013 functions/methods, 49% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`scripts.01`](scripts.01.md) — `__init__` … `repro_streaming_fault`
- [`scripts.02`](scripts.02.md) — `requirements_gen` … `verify_fase_a`
