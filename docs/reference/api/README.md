...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 14606 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`core.runtime.03`](core.runtime.03.md) — `refresh_tokens` … `workspace_paths`
