...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 14766 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`scripts.01`](scripts.01.md) — `__init__` … `jarvis_bare_practice_runner`
- [`scripts.02`](scripts.02.md) — `laering_status` … `verify_fase_a`
