...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 12041 functions/methods, 42% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
