...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 15256 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`scripts.03`](scripts.03.md) — `smoke_test_startup` … `verify_fase_a`
