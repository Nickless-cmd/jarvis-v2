...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 15117 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`apps.api.jarvis_api.routes.01`](apps.api.jarvis_api.routes.01.md) — `__init__` … `companion`
- [`apps.api.jarvis_api.routes.02`](apps.api.jarvis_api.routes.02.md) — `composer_suggest_routes` … `plugins`
- [`apps.api.jarvis_api.routes.03`](apps.api.jarvis_api.routes.03.md) — `presence` … `workbench`
