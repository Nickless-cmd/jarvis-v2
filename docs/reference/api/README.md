...
Generated per-package reference for `core/`+`apps/`+`scripts/`. 14854 functions/methods, 51% with docstrings. Undocumented public functions: see [`DOCSTRING_COVERAGE.md`](../DOCSTRING_COVERAGE.md).
...
- [`core.services.26`](core.services.26.md) — `visible_run_segment_settlement` … `world_model_signal_tracking`
