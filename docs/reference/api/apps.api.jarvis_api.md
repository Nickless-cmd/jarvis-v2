...
|---|---|---|---|---|
| function | `_runtime_services_enabled` | `()` | — | [src](../../../apps/api/jarvis_api/app.py#L139) |
| function | `wire_root_logging` | `()` | Giv modul-loggere et sted at lande. Uden dette er de ALLE stumme. | [src](../../../apps/api/jarvis_api/app.py#L144) |
| function | `create_app` | `()` | — | [src](../../../apps/api/jarvis_api/app.py#L199) |
