...
| method | `MessageStart.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L46) |
| class | `ContentBlockStart` | `` | Markerer start på en content-block (text, thinking, eller tool_use). | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L61) |
| method | `ContentBlockStart.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L73) |
| class | `ContentBlockDelta` | `` | Inkrementelt indhold til en aktiv content-block. | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L94) |
| method | `ContentBlockDelta.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L106) |
| class | `ContentBlockStop` | `` | Markerer at en bestemt content-block er færdig. | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L122) |
| method | `ContentBlockStop.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L130) |
| class | `MessageDelta` | `` | Opdaterer message-level metadata mod slutningen. | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L138) |
| method | `MessageDelta.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L150) |
| class | `MessageStop` | `` | Sidste event — assistant-svaret er færdigt. | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L164) |
| method | `MessageStop.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L167) |
| class | `Ping` | `` | Keepalive event hver ~5s under streaming. | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L172) |
| method | `Ping.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L179) |
| class | `SystemEvent` | `` | Jarvis-specifik extension der ikke passer i Anthropic-skema. | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L184) |
| method | `SystemEvent.to_sse_line` | `(self)` | — | [src](../../../apps/api/jarvis_api/sse_v2_events.py#L198) |
