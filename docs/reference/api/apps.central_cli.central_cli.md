...
| function | `resolve_command` | `(verb, args)` | Map (verb, args) → CommandSpec. Writes markeres write=True (til confirm-guard). | [src](../../../apps/central_cli/central_cli/commands.py#L69) |
