...
| function | `_fortsaet_hvis_budgettet_loeb_toert` | `(*, run_id, sid, startet, visible_args, eff_model, eff_provider, lane)` | Start en fortsættelse når terminal-policyen klassificerede segmentet | [src](../../../core/services/visible_runs_sections/detached_run.py#L299) |
