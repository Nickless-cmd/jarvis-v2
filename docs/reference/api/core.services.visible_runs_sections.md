...
| function | `start_or_attach_user_run` | `(*, message, session_id, nudge_enabled=…, **kw)` | Single-flight pr. session for server-autoritative runs. | [src](../../../core/services/visible_runs_sections/detached_run.py#L272) |
| function | `_fortsaet_hvis_budgettet_loeb_toert` | `(*, run_id, sid, startet, visible_args, eff_model, eff_provider, lane)` | Start en fortsættelse når terminal-policyen klassificerede segmentet | [src](../../../core/services/visible_runs_sections/detached_run.py#L359) |
