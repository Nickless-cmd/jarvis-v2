...
| function | `start_user_run_detached` | `(*, message, original_message=…, session_id, approval_mode=…, thinking_mode=…, force_user_id=…, tool_scope=…, provider_override=…, model_override=…, eff_model=…, eff_provider=…, lane=…, run_id=…, local_tool_exec=…, research_mode=…, recovery_task_id=…, recovery_generation=…, recovery_attempt=…, surface=…)` | Start et server-autoritativt run. Returnerer run_id (klienten abonnerer | [src](../../../core/services/visible_runs_sections/detached_run.py#L37) |
| function | `start_or_attach_user_run` | `(*, message, session_id, nudge_enabled=…, **kw)` | Single-flight pr. session for server-autoritative runs. | [src](../../../core/services/visible_runs_sections/detached_run.py#L278) |
| function | `_fortsaet_hvis_budgettet_loeb_toert` | `(*, run_id, sid, startet, visible_args, eff_model, eff_provider, lane)` | Start en fortsættelse når terminal-policyen klassificerede segmentet | [src](../../../core/services/visible_runs_sections/detached_run.py#L365) |
