...
# `get_affect` var async engang; det er den ikke mere. Testen pakkede den
# stadig i en event-loop og fejlede med «An asyncio.Future, a coroutine or an
# awaitable is required». Ruten kaldes nu direkte, som FastAPI selv gør det.
