...
def _stub_modules():
    ...
    user_model_daemon.event_bus = mock_bus
    user_model_daemon.insert_private_brain_record = MagicMock()
    user_model_daemon.recent_visible_runs = MagicMock(return_value=[])
    BUS_MOD = user_model_daemon
    DB_MOD = user_model_daemon
